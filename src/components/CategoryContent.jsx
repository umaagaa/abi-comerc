...
export default function CategoryContent({
  ...
  title,
  description,
  extraImages = [], // dodatne slike kad se prosiri
  reverse = false,
}) {
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 items-center'>
          ...
          <div className={`order-2 ${reverse ? 'lg:order-1' : 'lg:order-2'}`}>
            <div className='space-y-8'>
              ...
              <div className='grid grid-cols-2 gap-4 pt-4'>
                <div className='flex items-center space-x-3'>
                  ...
                  <span className='text-sm text-gray-600 font-medium'>
                    {t('categoryContent.quality')}
                  </span>
                </div>
                <div className='flex items-center space-x-3'>
                  <div className='w-2 h-2 bg-red-500 rounded-full'></div>
                  <span className='text-sm text-gray-600 font-medium'>
                    {t('categoryContent.innovation')}
                  </span>
                </div>
                <div className='flex items-center space-x-3'>
                  <div className='w-2 h-2 bg-green-500 rounded-full'></div>
                  <span className='text-sm text-gray-600 font-medium'>
                    {t('categoryContent.durability')}
                  </span>
                </div>
                <div className='flex items-center space-x-3'>
                  <div className='w-2 h-2 bg-red-500 rounded-full'></div>
                  <span className='text-sm text-gray-600 font-medium'>
                    {t('categoryContent.aesthetics')}
                  </span>
                </div>
              </div>
              ...
              >
                {expanded
                  ? t('categoryContent.hide')
                  : t('categoryContent.expand')}
              </button>
            </div>
          </div>
        </div>
